...
* Update to better handle including image assets in CSS and calculating directory the plugin is installed in.
...
* (fix) Activity feed works again (pointed at update API endpoint)
* (fix) Better output sanitization
